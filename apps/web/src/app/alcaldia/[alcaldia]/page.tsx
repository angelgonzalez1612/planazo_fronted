...
const ALCALDIA_SEO: Record<string, { heading: string; description: string; intro: string }> = {
  ...
  "miguel-hidalgo": {
    ...
    intro:
      "La alcaldía Miguel Hidalgo reúne Polanco, el corredor comercial más caro de América Latina desde los años ochenta, con el Bosque de Chapultepec, el pulmón más grande de la ciudad, con ocupación humana desde hace más de dos mil años y un castillo que fue Colegio Militar antes de convertirse en museo. Es la alcaldía de los museos de clase mundial y la alta cocina de la ciudad.\n\nDentro de esa misma zona, en el límite con Chapultepec, está Los Pinos, residencia oficial de catorce presidentes de México durante 84 años. Cuando Andrés Manuel López Obrador cumplió su promesa de campaña de no vivir ahí, el complejo abrió sus puertas al público el 1 de diciembre de 2018 como espacio cultural de acceso libre y gratuito, y hoy se puede recorrer casa por casa —incluidas la de Lázaro Cárdenas y la de Venustiano Carranza— la historia reciente del poder presidencial mexicano.",
  },
};
